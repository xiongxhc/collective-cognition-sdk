...
**Status:** Tasks 1–3 complete. Task 4 documentation reconciliation is complete; the full local gate, immutable-history/package inventory checks, independent whole-branch review, and final evidence remain pending.
...
- [x] **Step 1: Write the failing closed-profile test**
...
- [x] **Step 3: Add the minimal closed profile and normative prose**
...
- [x] **Step 5: Review Task 1 against the design**
...
- [x] **Step 1: Extend the test before writing documentation**
...
- [x] **Step 3: Write the public API reference**
...
- [x] **Step 4: Re-run and prove GREEN against the current baseline**
...
- [x] **Step 5: Review Task 2 for usability**
...
- [x] **Step 1: Write package and compatibility expectations first**
...
- [x] **Step 2: Run package and compatibility tests and prove RED**
...
- [x] **Step 3: Add package metadata and baseline**
...
- [x] **Step 4: Record exact finalized digests**
...
- [x] **Step 5: Run focused package, compatibility, and profile tests**
...
- [x] **Step 1: Reconcile public status without overclaiming**
