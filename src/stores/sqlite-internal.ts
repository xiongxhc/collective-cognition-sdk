...
export interface SqliteCognitionStoreInternalOptions {
  readonly databasePath: string;
  readonly createIfMissing?: boolean;
  readonly busyTimeoutMs?: number;
}

interface SqliteCognitionStoreInternalOptionsSnapshot {
  readonly databasePath: string;
  readonly createIfMissing: boolean;
  readonly busyTimeoutMs: number;
}
...
export interface SqliteCognitionSchemaTarget {
...
function snapshotOptions(
  value: SqliteCognitionStoreInternalOptions,
): SqliteCognitionStoreInternalOptionsSnapshot {
  ...
  } as SqliteCognitionStoreInternalOptionsSnapshot;
}
...
export const sqliteCognitionStoreSchemaTarget: SqliteCognitionSchemaTarget =
  Object.freeze({
    allowedVersions: Object.freeze([1, 2] as const),
    creationSchemaProfile: schemaVersionOne,
  });

export const sqliteCognitionWorkflowSchemaTarget: SqliteCognitionSchemaTarget =
  Object.freeze({
...
function openCompatibleCognitionTarget(
  snapshot: SqliteCognitionStoreInternalOptionsSnapshot,
  allowedVersions: ReadonlySet<number>,
  schemaProfile: SchemaProfile,
): DatabaseSync {
...
export class SqliteCognitionStoreBase implements CognitionStore {
  readonly #database: DatabaseSync;

  constructor(
    options: SqliteCognitionStoreInternalOptions,
