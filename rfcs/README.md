...
- [RFC 0003: Portable Cognition Contract](0003-portable-cognition-contract.md) — implemented and final-review verified in Phase 3 with a Normative Stable `0.1.0` exchange envelope and a historical private package `0.2.0` surface; the current package is private, unpublished `0.7.0`.
...
- [RFC 0008: Runtime and Security Profile](0008-runtime-security-profile.md) — implemented and verified in the source checkout and private, unpublished package `0.7.0`, with a versioned JSON inventory at `collective-cognition-sdk/runtime-security/0.1.0`, explicit `sdk-enforced`, `conformance-verified`, `host-required`, and `out-of-scope` classes, and a boundary that leaves authentication, encryption, tenant or workspace isolation, and durable publication recovery host-owned. Conformance is not certification.
